...
| CUM-138-06 | UX | `src/main.rs` graph projection、Windows Graphing/ViewModel/Control | 既存9 causal caseにASTRA指定4単価、旧3モデル既知/incomplete破線、period選択後pollのbounded reset aliasを同一到達経路として統合し、X/Windowsで独立検証 | implemented |
