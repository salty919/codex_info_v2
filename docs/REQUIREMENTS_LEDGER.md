...
| G137-GRAPH-01 | PRODUCT | `src/main.rs` graph projection、Windows Core/ViewModels/Graphing、保存fixture/E2E | `G137-1`..`G137-10`の同一literal inputについて両platformがmodel universe、accepted値、solid/dashed/break、idle、raw/effective quota、最新label、pair/cursor回復、failure isolationを独立照合 | implemented |
