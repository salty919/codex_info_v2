    ...
    pub fn text(&self, key: TextKey) -> &'static str {
        ...
        match self.language {
            Language::Japanese => match key {
                ...
                QuotaNearlyGone => "残量は 2% 以下です。",
                QuotaLow => "残量は 10% 以下です。",
                ResetWithinDay => "24 時間以内に利用枠がリセットされます。",
                LastUpdated => "前回受信",
                PartialHistoryThreads => {
...
fn basic_text(key: TextKey, language: &str) -> &'static str {
    ...
    match (language, key) {
        ...
        ("en", QuotaNearlyGone) => "Remaining quota is 2% or less.",
        ("en", QuotaLow) => "Remaining quota is 10% or less.",
        ("en", ResetWithinDay) => "The quota resets within 24 hours.",
        ("en", LastUpdated) => "Last received",
        ...
        ("zh", QuotaNearlyGone) => "剩余配额不超过 2%。",
        ("zh", QuotaLow) => "剩余配额不超过 10%。",
        ("zh", ResetWithinDay) => "配额将在 24 小时内重置。",
        ("zh", LastUpdated) => "上次接收",
...
const ES_CATALOG: [&str; 81] = [
    ...
    "La cuota restante es del 2% o menos.",
    "La cuota restante es del 10% o menos.",
    "La cuota se restablece en 24 horas.",
    "Última recepción",
...
const FR_CATALOG: [&str; 81] = [
    ...
    "Le quota restant est inférieur ou égal à 2 %.",
    "Le quota restant est inférieur ou égal à 10 %.",
    "Le quota sera réinitialisé sous 24 heures.",
    "Dernière réception",
...
const PT_CATALOG: [&str; 81] = [
    ...
    "A cota restante é de 2% ou menos.",
    "A cota restante é de 10% ou menos.",
    "A cota será redefinida em 24 horas.",
    "Último recebimento",
...
const IT_CATALOG: [&str; 81] = [
    ...
    "La quota residua è pari o inferiore al 2%.",
    "La quota residua è pari o inferiore al 10%.",
    "La quota verrà ripristinata entro 24 ore.",
    "Ultima ricezione",
...
const RU_CATALOG: [&str; 81] = [
    ...
    "Остаток квоты не превышает 2%.",
    "Остаток квоты не превышает 10%.",
    "Квота будет сброшена в течение 24 часов.",
    "Последнее получение",
